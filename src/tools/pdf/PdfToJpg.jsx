...
function PdfToJpg() {
  ...
  async function convertAllPages(loadedPdf) {
    ...
    try {
      ...
      console.log(
        `Converted ${renderedImages.length} pages to JPG`
      )
    } catch (err) {
      console.error(
      ...
      setError(
        'Could not convert the PDF pages to JPG.'
      )
  ...
  return (
    <>
      <SEO
        ...
        description="Convert PDF pages to JPG images online with Pixora."
      />
      ...
      <section className="px-4 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-gray-600">
            Convert your PDF pages into JPG
