...
function PdfToJpg() {
  ...
  function downloadImage(imageUrl, pageNumber) {
    ...
    link.href = imageUrl
    link.download = `pixora-page-${pageNumber}.jpg`
  ...
  return (
    <>
      <ToolPageSEO
        ...
        description="Convert PDF pages to JPG images online for free with Pixora. Download individual JPG pages or all converted pages as a ZIP file directly in your browser."
      />
        ...
        <div className="mx-auto max-w-4xl">
            ...
            {[
              {
                ...
                text: 'Convert PDF pages into JPG images directly in your browser.',
              },
              {
                icon: FiShield,
                title: 'Browser Based',
              ...
              },
              {
                ...
                text: 'Download individual JPG pages or collect all pages in one ZIP file.',
              },
            ].map((benefit) => {
          ...
          >
            ...
            <p className="mt-4 leading-7 text-gray-600">
              Pixora's PDF to JPG converter lets you turn PDF pages
              into JPG images quickly and easily. The tool converts
              every page of a selected PDF into an individual JPG
              image that can be downloaded separately or together
              as a ZIP file.
            </p>

            <p className="mt-4 leading-7 text-gray-600">
              The conversion happens directly in your browser, making
              it useful when you need JPG versions of PDF pages for
              websites, documents, image sharing, previews or other
              digital projects.
            </p>
            ...
            <ol className="mt-4 space-y-3 text-gray-600">
              <li>
                ...
                Upload your PDF file to Pixora.
              </li>
              ...
              <li>
                ...
                Pixora processes each PDF page as a JPG image.
              </li>
              ...
              <li>
                ...
                Download individual JPG pages or all pages as a ZIP.
              </li>
            </ol>
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              {[
                'Create image versions of PDF pages for easy sharing.',
                'Use individual PDF pages as images in digital projects.',
                'Preview PDF content as standard JPG files.',
            ...
            <h3 className="mt-8 text-xl font-semibold text-[#1D4533]">
              Free PDF Page to Image Converter
            </h3>

            <p className="mt-4 leading-7 text-gray-600">
              Pixora is designed to make common PDF and image
              conversions simple. With the PDF to JPG converter,
              you can process PDFs up to 20 MB and receive separate
              ...
              {[
                {
                  ...
                  answer:
                    'Yes. Pixora converts each page of the selected PDF into a separate JPG image.',
                },
                {
                  question:
                    'How large can my PDF file be?',
                  answer:
                    'The current Pixora PDF to JPG converter accepts PDF files up to 20 MB.',
                },
                {
                  question:
                    'Can I download only one PDF page as JPG?',
                  answer:
                    'Yes. Every converted page has its own download button, so you can download individual JPG pages.',
                },
                {
                  question:
                    'Can I download all converted JPG pages together?',
                  answer:
                    'Yes. Use the Download All as ZIP button to collect all converted pages in one ZIP file.',
                },
                {
                  question:
                    'Does PDF to JPG work on mobile devices?',
                  answer:
