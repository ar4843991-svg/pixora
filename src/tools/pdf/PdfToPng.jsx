...
function PdfToPng() {
  ...
  return (
    <>
      <SEO
        title="PDF to PNG Converter Online | Pixora"
        description="Convert PDF pages to PNG images online for free with Pixora. Download individual PNG pages or all converted pages as a ZIP file."
      />
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-gray-600 sm:text-lg">
              Convert PDF pages into high-quality PNG images directly
              in your browser. Download individual pages or all
          ...
          >
            ...
            {isConverting && (
              ...
              >
                Converting each PDF page into a PNG image. Please
                keep this tab open.
              </motion.div>
            )}
          ...
          >
            ...
            <p className="mt-4 leading-7 text-gray-600">
              Pixora PDF to PNG Converter lets you turn PDF pages
              into PNG images directly in your browser. Each page is
              rendered as an individual PNG image that you can
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                'Preview the converted PNG pages.',
            ...
            <p className="mt-4 leading-7 text-gray-600">
              PNG images are useful when you want a lossless image
              representation of a PDF page. They can be helpful for
              screenshots, graphics, documents and workflows where
